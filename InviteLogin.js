      ...
      <div className="Login">
        <div className="loginNav">
          <div className="teamContact">
            <div className="logoNav">
              <a className="logoNavLink" href="#Home">
                <img src="http://i64.tinypic.com/2rpfv6g.png" alt="Logo"/></a>
            </div>
            <div className="teamContactBox">
              <div className="team">
                <a className="aTeam" href="#team">Team</a>
              </div>
              <div className="contact">
                <a className="aTeam" href="#Contact">Contact</a>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="opacityBox">
                ...
                <div>
                  <button className="loginBtn" onClick={this.props.onLogin}>
                    <i className="fa fa-facebook-square fa" aria-hidden="true"></i>&nbsp;Sign in with Facebook</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bodyBox">
          <div className="bodyTitle">
            ...
            <p className="bodySecondText">Co-Habitation. Simplified.</p>
          </div>
